...
- **myFund fetch** — pulls the configured portfolio. Needs
...
- **Home Assistant publish** — pushes household metrics over MQTT.
...
watched-folder intake and classifier retraining.
"""
