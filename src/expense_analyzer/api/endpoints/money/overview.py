...
from expense_analyzer.queries.money.transactions import UNCATEGORIZED
...
# The overview is the dashboard landing page (""). /stats stays as an explicit
# alias so the nav "Overview" link and any deep links keep working.
