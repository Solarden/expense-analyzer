...
from expense_analyzer.queries.planning import loan_documents as doc_queries
...
def loans_page(request: Request, user: CurrentUser, session: DbSession) -> HTMLResponse:
    return templates.TemplateResponse(request, "planning/loans.html", _loans_context(session, user))
